...
const markdown_cicero_1 = require("@accordproject/markdown-cicero");
const index_browser_js_1 = require("@accordproject/ergo-engine/index.browser.js");
...
function validateTextDocument(textDocument) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (modelValid) {
                const grammarValid = yield validateGrammar(textDocument, diagnosticMap, templateCache);
...
function validateModels(textDocument, diagnosticMap, templateCache) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // get the template logic from cache
            const logicManager = new ergo_compiler_1.LogicManager('cicero');
 ...
 */
function validateGrammar(textDocument, diagnosticMap, templateCache) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const pathStr = path.resolve(fileUriToPath_1.default(textDocument.uri));
            const parentDir = getTemplateRoot(pathStr, textDocument, diagnosticMap);
            ...
            try {
                ...
                const parserManager = new markdown_template_1.ParserManager(modelManager, null, packageJson.accordproject.template);
                ...
                const ergoEngine = new index_browser_js_1.EvalEngine();
                parserManager.setFormulaEval((name) => cicero_core_1.TemplateInstance.ciceroFormulaEval(logicManager, packageJson.name, ergoEngine, name));
                ...
                pushDiagnostic(vscode_languageserver_1.DiagnosticSeverity.Error, textDocument, error, 'grammar', diagnosticMap);
            }
        }
        catch (error) {
            connection.console.error(error.message);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                const ciceroMarkTransformer = new markdown_cicero_1.CiceroMarkTransformer();
